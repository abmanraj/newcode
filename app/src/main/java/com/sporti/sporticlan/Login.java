...
import static com.sporti.sporticlan.R.id.login;
import static com.sporti.sporticlan.R.id.never;
                                ...
                                public void onCallback(String response) {
                                  /*  Toast.makeText(Login.this, ""+response, Toast.LENGTH_SHORT).show();*/
                                    ...
                                    if(md.getStatus()==1)
                                    {
                                        ...
                                        int id=md.getUserDetail().getRid();
                                       /* Toast.makeText(Login.this, ""+md.getMessage(), Toast.LENGTH_SHORT).show();*/
                                        editor.putInt("id",id);
                                        editor.commit();
